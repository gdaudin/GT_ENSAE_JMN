...
reasoning. Therefore, Jacks and al.'s approach cannot be an
alternative to traditional investigations of impediments to
trade, such as commodity price gaps.

This paper starts by presenting Jacks and al.'s approach of the
...
why Jacks and al.'s aggregation technique ends up providing
different results for the two globalizations. We argue that
what Jacks and al. misleadingly attribute to unequal trade costs
...
Jacks and al. first depart from \cite{AW2003} by eliminating the
...
arbitrage condition Jacks and al. base their computation on is an
...
However the main conclusion in Jacks and al.'s article, namely
...
Jacks and al.\footnote{Contributions of growth in income
...
Jacks and al.'s conclusion on a difference of nature between the
...
expression is given by Jacks and al.'s key equation
...
Jacks and al's method.\footnote{They include unweighted and
...
to allow a clear comparison with Jacks and al.'s results. There
...
Our explanation of why Jacks and al.'s aggregate measure of
...
$i$. Jacks and al.'s variable of trade costs between $k$ and
...
behavior of trade flows. But Jacks and al.'s measure also
...
the arithmetic mean ($m$) and of Jacks and al.'s mean
...
Jacks and al.'s measure is biased toward the growth rates of
