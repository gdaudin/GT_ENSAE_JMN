...
Their conclusion on the difference between the two globalization periods comes from the fact that the dyads with the fastest growing trade in the first wave of globalization start with very small trade and this this is not the case in the second wave of globalization.
