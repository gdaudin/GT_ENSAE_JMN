...
preserve
gen France=mistakein if ctyi=="France"
gen UK=mistakein if ctyi=="UK"
gen USA=mistakein if ctyi=="USA"
keep if ctyj=="Australia"
line France UK USA year, lpattern(dash dash_dot solid) title("{&tau}k (JMN) for France, the UK and the USA, 1870-1913")
restore
...
gen aij=sqrt(xii*xjj*0.64)
gen bij=sqrt((xij*xji)/(xii*xjj*0.64))
